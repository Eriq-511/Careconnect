  ...
  return (
    <>
      ...
      <div className="max-w-2xl mx-auto py-10 px-2 sm:px-4 text-center">
        <h2 className="text-2xl sm:text-3xl font-bold mb-4 text-primary-900" tabIndex={0} aria-label="Babysitter Dashboard">Babysitter Dashboard</h2>
        {loading ? <LoadingSpinner /> : user && (
          <>
            ...
            <div className="flex flex-col sm:flex-row flex-wrap gap-3 sm:gap-4 items-center justify-center">
              <Link to="/babysitter/profile" className="w-full sm:w-auto px-4 py-2 bg-primary-600 text-white rounded-lg font-semibold shadow hover:bg-primary-700 transition text-base sm:text-lg focus:outline-none focus:ring-2 focus:ring-primary-500" aria-label="Edit Profile">Edit Profile</Link>
              <Link to="/directory" className="w-full sm:w-auto px-4 py-2 bg-secondary-500 text-white rounded-lg font-semibold shadow hover:bg-secondary-600 transition text-base sm:text-lg focus:outline-none focus:ring-2 focus:ring-secondary-400" aria-label="Find Jobs">Find Jobs</Link>
